...
- "word": слово или выражение на изучаемом языке. Для английского — само слово. Для японского — запись КАНОЙ, никогда не кандзи: хираганой для исконно японских слов, КАТАКАНОЙ для заимствований (например, コーヒー, パソコン) — то есть та запись каной, которая для этого слова общепринята;
